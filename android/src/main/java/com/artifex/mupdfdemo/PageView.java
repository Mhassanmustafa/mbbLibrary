...
public abstract class PageView extends ViewGroup {
    private static final float ITEM_SELECT_BOX_WIDTH = 2.0f;

    private static final int HIGHLIGHT_COLOR = 0x80ff5722;
    private int LINK_COLOR = 0x80ff5722;
//    private static final int BOX_COLOR = 0xFF4444FF;
    private static final int BOX_COLOR = 0xFF696969;
//    private static final int INK_COLOR = 0xFF000000;
    private int INK_COLOR = 0xFFF00000;
//    private static final float INK_THICKNESS = 10.0f;
    private float INK_THICKNESS = 8.0f;
